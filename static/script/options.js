    ...
    tabs.createTab('tabs', app.createElement(
        ...
        [
            app.createElement('section', [
                ...
                app.createElement('p', 'Change the title of PickleHub\'s browser tab title.', {
                    style: {
                        'margin-bottom': '0'
                    }
                })
            ...
            app.createElement('section', [
                ...
                app.createElement('p', 'Change the icon of PickleHub\'s browser tab. To change it into something like Google, type in "https://www.google.com/favicon.ico"', {
                    style: {
                        'margin-bottom': '0'
                    }
                })
